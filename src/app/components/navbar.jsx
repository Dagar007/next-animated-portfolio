    ...
    <div className='h-full flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl'>
      ...
      <div className='md:hidden lg:flex xl:w-1/3 xl:justify-center'>
        <Link href="/" className='text-sm bg-black rounded-md p-1 font-semibold flex justify-center items-center'>
          ...
          <span className='w-12 h-8 rounded bg-white text-black flex justify-center items-center'>Kumar</span>
          </Link>
      </div>
      <div className='hidden md:flex gap-4 w-1/3'>
          <Link href='https://github.com/Dagar007'>
            <Image src="/github.png" alt='github' width={24} height={24} />
          </Link>
          <Link href='https://www.instagram.com/tiny0007/'>
            <Image src="/instagram.png" alt='instagram' width={24} height={24} />
          </Link>
          <Link href='https://www.facebook.com/tiny0007/'>
            <Image src="/facebook.png" alt='github' width={24} height={24} />
          </Link>
          <Link href='https://www.linkedin.com/in/deepak-kumar-98687551/'>
